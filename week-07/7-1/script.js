...
const w = W - margin.l - margin.r; // 'bake in the margins' somehow
const h = H - margin.t - margin.b;

//chart-1: using for... loop
const plot1 = d3.select("#chart-1") //plot1 is a "flag" pointing to g, lowest appended element
	.append('svg')
	.attr('width', W)
	.attr('height', H)
	.append('g')
...
popRanking1.forEach(function(d, i){
	...
	const x = w/3 * i; // distributed evenly across the page. Figure out how this works.
	const y = h/2;
